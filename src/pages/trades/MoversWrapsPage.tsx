  ...
  return (
    <>
      ...
      <TradeHero 
        tradeName="Moving"
        tradeIcon={Truck}
        description="Move your business forward with professional vehicle graphics that build trust and drive bookings across Chicago."
        benefits={["Trusted & Reliable", "Licensed & Insured", "Professional Service", "Careful Handling"]}
        startingPrice="$2,000"
      />
