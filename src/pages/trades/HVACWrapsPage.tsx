...
const HVACWrapsPage = () => {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative min-h-[600px] flex items-center justify-center bg-gradient-to-br from-orange-900 via-red-800 to-orange-700 text-white overflow-hidden">
