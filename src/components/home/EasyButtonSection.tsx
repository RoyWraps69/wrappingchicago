...
const EasyButtonSection = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-gray-900 to-black py-8 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="bg-red-600 text-white text-center py-2 px-4 rounded-t-lg mx-auto w-fit mb-2 shadow-lg transform -rotate-1">
          <span className="font-bold tracking-wide text-white">EXCLUSIVE FLASH SALE ENDS {formattedEndDate}</span>
        </div>
          ...
          <Card className="md:col-span-3 bg-white/10 backdrop-blur-sm border-white/20 shadow-xl">
            <CardContent className="p-6">
              ...
              <p className="text-white mb-6 text-lg max-w-2xl">
                Professional design, premium materials, and expert installation for one all-inclusive price of just <span className="font-bold text-yellow-300 text-xl">$3,999</span> — with <span className="font-bold underline text-white">no hidden fees</span> (up to 400 sq ft).
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">Custom design tailored to your business</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <Check className="h-5 w-5 text-green-400 mr-2 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">Full coverage for peace of mind</p>
                  </div>
                </div>
              </div>
              
              <Alert className="bg-yellow-400/10 border border-yellow-400/30 mb-6">
                <CalendarClock className="h-4 w-4 text-yellow-400" />
                <AlertTitle className="text-yellow-200">Limited Availability!</AlertTitle>
          ...
          <Card className="md:col-span-2 bg-gradient-to-br from-brand-red to-red-800 border-white/20 shadow-xl">
            <CardContent className="p-6">
              ...
              <div className="flex items-end gap-3 mb-2">
                <div className="line-through text-white/70 text-lg">$5,499</div>
                <div className="text-4xl font-bold text-white">$3,999</div>
                <div className="text-white/90 text-sm self-end mb-1">all-inclusive</div>
              </div>
              ...
              <div className="bg-white/10 rounded-lg p-3 mb-6">
                ...
                <div className="pl-6 text-white/90 text-sm space-y-1">
