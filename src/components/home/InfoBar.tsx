      ...
      <div className="container mx-auto py-8 px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex items-center gap-4 group">
            <div className="w-12 h-12 rounded-full bg-brand-red/10 flex items-center justify-center group-hover:bg-brand-red transition-colors duration-300">
              <Check className="text-brand-red h-5 w-5" />
            </div>
            <div>
              <h3 className="font-bold text-lg text-white">16,000+ Wraps</h3>
              <p className="text-white/70 text-sm">Completed Successfully</p>
            </div>
          </div>
          
          <div className="flex items-center gap-4 group">
            <div className="w-12 h-12 rounded-full bg-brand-red/10 flex items-center justify-center group-hover:bg-brand-red transition-colors duration-300">
              <Shield className="text-brand-red h-5 w-5" />
            </div>
            <div>
              <h3 className="font-bold text-lg text-white">Premium Materials</h3>
              <p className="text-white/70 text-sm">3M & Avery Dennison</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 group">
            ...
            <div>
              ...
              <p className="text-white/70 text-sm">With Proper Maintenance</p>
            </div>
          </div>
