...
const ProtectiveFilmsContent: React.FC = () => {
  return (
    <>
      <h2 className="text-2xl font-semibold text-brand-navy mb-4">Vehicle Protective Films</h2>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white shadow p-6 rounded-lg">
          <h3 className="text-xl font-semibold text-brand-navy mb-3">Protection Options</h3>
        ...
        <div className="bg-white shadow p-6 rounded-lg">
          <h3 className="text-xl font-semibold text-brand-navy mb-3">Benefits of Protective Films</h3>
          <ul className="list-disc pl-5 space-y-2 text-gray-700">
