...
const EnhancedLocationHero = ({ city }: EnhancedLocationHeroProps) => {
  ...
  return (
    <section className="bg-gradient-to-r from-gray-900 to-black text-white py-16 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center mb-4">
            ...
            <span className="text-white font-medium">5-Star Rated Fleet Wraps Company</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              ...
              <div className="text-white">Vehicles Wrapped</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              ...
              <div className="text-white">Fast Turnaround</div>
            </div>
          </div>
