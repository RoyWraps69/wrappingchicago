...
export const galleryItems: GalleryItem[] = [
  { 
    ...
    image: '/lovable-uploads/efc6c586-8651-43ad-811a-b896a91a1b69.png', // Updated: using fleet image
  ...
  { 
    ...
    image: '/lovable-uploads/6d45d332-9949-413e-b840-8007afa41d56.png', // Updated: using color change image
  ...
  { 
    ...
    image: '/lovable-uploads/0ec34598-bcc3-486d-9021-dd527bafe83a.png', // Updated: using commercial graphics image
  ...
  { 
    id: 4, 
    title: 'Creative Vehicle Graphics', 
    category: 'Partial Wraps',
    image: '/lovable-uploads/cc335205-fcef-4ca9-a269-5cf6dee478ed.png', // Updated: using partial wrap image
    description: 'Eye-catching partial wrap design for mobile business with key marketing highlights.',
  ...
  { 
    ...
    category: 'Fleet Wraps',
    image: '/lovable-uploads/22a9b401-dc9c-4e13-90da-50d4e85ea3ca.png', // Updated: using another fleet image
  ...
  { 
    ...
    category: 'Color Change Wraps',
    image: '/lovable-uploads/f564c255-9ca3-4457-bef5-c940a4a1557a.png', // Updated: using color change wrap
  ...
  { 
    ...
    category: 'Commercial Graphics',
    image: '/lovable-uploads/fb7a4b97-4b57-4b2e-8f81-42a1098270df.png', // Updated: using truck commercial graphics
  ...
  { 
    ...
    category: 'Partial Wraps',
    image: '/lovable-uploads/d2a8e418-117f-4bfc-a6a2-efb63dbbce7f.png', // Updated: using sports car image
  ...
  { 
    ...
    category: 'Fleet Wraps',
    image: '/lovable-uploads/efdbc4bf-1f04-42bb-a904-f52dae7bef6c.png', // Updated: using professional fleet image
  ...
  { 
    ...
    category: 'Commercial Graphics',
    image: '/lovable-uploads/9bb3d94e-589d-4daf-b35e-e19e80610439.png', // Updated: using van image
  ...
  { 
    ...
    category: 'Color Change Wraps',
    image: '/lovable-uploads/676b4902-7b81-4619-90d8-8feb1f986636.png', // Updated: using black wrap
  ...
  { 
    ...
    category: 'Partial Wraps',
    image: '/lovable-uploads/77a1f4b1-efe3-4779-8646-f92e01667a29.png', // Updated: using partial wrap image
